...
const verifyToken = async (response: any) => {
  ...
  // Handle both credential (ID token) and access_token depending on flow
       ...
       <div class="z-10 h-full flex flex-col justify-between">
          ...
          <div class="mt-8 flex gap-3 z-10">
             <button 
                ...
                :class="currentSlide === index ? 'w-8 bg-amber-500' : 'w-2 bg-gray-700 hover:bg-gray-600'"
             ></button>
          </div>
       </div>
    </div>
          ...
          <div class="flex flex-col gap-4">
             <div class="w-full">
               ...
               <button 
                  ...
                  class="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-medium py-3 px-4 rounded-full hover:bg-gray-100 transition-all focus:ring-4 focus:ring-gray-700 focus:outline-none disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
               >
                  ...
                  <span v-if="!isVerifying">Sign in with Google</span>
               </button>
             </div>
