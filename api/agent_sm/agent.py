...
BUSINESS_TERMINOLOGY_INSTRUCTIONS = (
    "CRITICAL OUTPUT FORMATTING (STRICTLY ENFORCE):\n"
    "- NEVER expose technical database identifiers. This includes:\n"
...
content_creator = LlmAgent(
    ...
    instruction=(
        ...
        "\n"
        f"{BUSINESS_TERMINOLOGY_INSTRUCTIONS}\n"
        "\n"
...
auditor = LlmAgent(
    ...
    instruction=(
        ...
        "- Use the BigQuery tools to independently verify key data points and metrics mentioned in the [DRAFT REPORT].\n"
        "- Do not rely solely on the writer's draft; perform your own queries to ensure data integrity.\n"
        "\n"
        f"{BUSINESS_TERMINOLOGY_INSTRUCTIONS}\n"
        "\n"
        "CRITICAL OUTPUT FORMAT:\n"
        "You MUST output the original content you received, followed by a [VERIFICATION TABLE] and your audit findings.\n"
        "\n"
        "Use this structure:\n"
        "[DRAFT REPORT]\n"
        ...
        "\n"
        "[VERIFICATION TABLE]\n"
        "| Metric/Claim | Draft Value | Audited Value | Status | Notes |\n"
        "| :--- | :--- | :--- | :--- | :--- |\n"
        "(Populate based on your independent queries. Status can be: 'Match', 'Mismatch', or 'Revised'.)\n"
        "\n"
        "[AUDIT FINDINGS]\n"
        "(Your detailed findings and compliance notes here)\n"
        "\n"
