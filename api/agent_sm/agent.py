...
content_creator = LlmAgent(
    ...
    instruction=(
        ...
        "- In your final report, NEVER mention technical terms like 'sales_marketing', 'crm_datahub', 'callbox-core', schema names, or table names.\n"
        "- Instead, use business-friendly terminology:\n"
        "  • 'sales_marketing' dataset → 'Sales Performance Data'\n"
        "  • 'crm_datahub' dataset → 'CRM Data' or 'Campaign Activities and Engagement Data'\n"
        "  • Specific tables → translate to business context (e.g., 'campaign_activities' → 'Campaign Activities')\n"
